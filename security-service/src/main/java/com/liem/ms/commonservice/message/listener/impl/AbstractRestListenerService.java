package com.liem.ms.commonservice.message.listener.impl;

import static com.liem.ms.commonservice.specifications.BaseSpecification.Spec;
import static com.liem.ms.commonservice.specifications.SearchCriteria.criteriaEqual;
import static com.liem.ms.commonservice.specifications.SearchCriteria.criteriaTimestampGreaterThanOrEqual;
...
import com.liem.ms.commonservice.message.RestMessageType;
import com.liem.ms.commonservice.message.common.MessageOrigin;
import com.liem.ms.commonservice.message.listener.MessageListener;
import com.liem.ms.commonservice.service.CommandService;
import com.liem.ms.commonservice.service.QueryService;
import com.liem.ms.commonservice.specifications.BaseSpecification;
...
abstract public class AbstractRestListenerService<
  ...
  protected Specification<ENTITY> createSpecification(final DTO dto) {
    return BaseSpecification
        ...
        .and(Spec(StringUtils.hasText(dto.getUpdatedAt()) ?
            criteriaTimestampGreaterThanOrEqual("updatedAt", dto.getUpdatedAt()) :
            criteriaEqual("updatedAt", dto.getUpdatedAt())))
